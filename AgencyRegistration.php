...
if ($_SERVER["REQUEST_METHOD"] == "POST" and isset($_POST)) {
  ...
  $mail = test_input($_POST["mail"]);
    ...
    if ($dis){
      // THROW ERROR MESSAGE
      header("Location: AgencyRegistration.php?error=1");
      die();
    }
    ...
    $qr="INSERT INTO `agencies`(`name`, `password`, `mail`) VALUES ('$name','$pass','$mail')";
    $res=mysqli_query($con,$qr);
    ...
    $_SESSION['mail']=$mail;
    $qr2="SELECT `agency_id` FROM agencies WHERE mail='$mail' ";
    $res2=mysqli_query($con,$qr2);
    $dis2=mysqli_fetch_assoc($res2);
    $_SESSION['id']=$dis2['agency_id'];
    ...
    <div class="container">
      <div class="row justify-content-md-center">
        <div class="col-sm-12 text-center">
          <h3><i class="fa-sharp fa-solid fa-building"></i> Agency registration</h3>
        </div>
        <div class="col-sm-6">
